...
user1.products.create(name: "PS2", price: 4300.50, description: "Ps2 preto em excelente estado", quantity: 2, category: "console")
...
user4.products.create(name: "PS1", price: 4300.50, description: "Ps1 branco em excelente estado", quantity: 1, category: "console")
puts "Concluido"
